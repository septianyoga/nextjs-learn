...
const ProductView = ({ products }: { products: ProductType[] }) => {
    return (
        <div className="px-20">
            <h1 className="text-3xl font-bold text-center my-5">Product</h1>
            <div className="flex gap-5 justify-center flex-wrap">
                {products.length <= 0 ? (
                    <>
                        <div role="status" className="max-w-sm w-screen p-4 border border-gray-200 rounded shadow animate-pulse md:p-6">
                        ...
                        {products.map((product: ProductType) => (
                            <div key={product.id} className="max-w-sm rounded overflow-hidden shadow-lg">
                                ...
                                <div className="px-6 py-4">
                                    ...
                                    <p className="mt-3 font-semibold">{parseFloat(product.price).toLocaleString("id-ID", {
                                        style: "currency",
                                        currency: "IDR"
                                    })}</p>
